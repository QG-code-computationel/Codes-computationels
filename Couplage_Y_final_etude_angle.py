...
# Largeur totale de la fenêtre de simulation. On ajoute une marge de 100 µm pour éviter les réflexions sur les bords.
...
dn = n1 - n0                 # Différence d'indice
LargeurGuide = 5.e-6         # Largeur physique du guide d'onde

x = np.linspace(-largeur/2, largeur/2, N) # Tableau des coordonnées X
dx = x[1] - x[0]                          # Pas spatial réel
milieu = N // 2                           # Indice du pixel central

dz = 0.1e-6                  # Pas de propagation longitudinal
distance = 1000.e-6          # Longueur totale de la simulation
